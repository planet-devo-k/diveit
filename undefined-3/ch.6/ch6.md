...
| **문제점**    | **익명 함수**, 익명 `default export`, 일부 **고차 컴포넌트**는 **Anonymous** 또는 `_default`로 표시됨. | <p>1. 컴포넌트를 <strong>기명 함수</strong>로 선언.<br>2. 함수에 <strong><code>displayName</code></strong> 속성을 추가.</p> |
