...
![pre-rendering1](<../.gitbook/assets/pre-rendering1 (2).png>) ![csr](<../.gitbook/assets/csr (2).png>) ![csr page 이동](<../.gitbook/assets/csr-page (2).png>) ![HTML rendering](<../.gitbook/assets/rendering1 (2).png>) ![브라우저 화면 rendering](<../.gitbook/assets/rendering2 (2).png>)

* 넥스트 서버는 첫 화면 렌더링 이후 곧바로 브라우저에게 우리가 작성한 모든 JS코드를(리액트 앱 번들링해서) 넘겨준다.

![pre-rendering2](<../.gitbook/assets/pre-rendering2 (2).png>)

* hydration → TTI(Time to Interactive)

![pre-rendering3](<../.gitbook/assets/pre-rendering3 (2).png>)

* 초기 렌더링 이후 페이지 렌더링

![초기 렌더링 이후 페이지 렌더링](<../.gitbook/assets/page-rendering (2).png>)

![pre-rendering](<../.gitbook/assets/pre-rendering (2).png>)
