...
* Number 타입의 값을 Number Literal 타입의 변수에 할당하는 것은 Number 타입의 값을 Number Literal 타입의 값으로 취급 하겠다는 것 입니다. 이렇게 더 큰 타입의 값을 더 작은 타입의 값으로 취급하는 것은 안됩니다. ![타입 호환성1](../.gitbook/assets/type-compatibility1.png) ![타입 호환성2](../.gitbook/assets/type-compatibility2.png)
